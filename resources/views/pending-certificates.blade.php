...
<div class="page-heading">
    <div>
        ...
        <p>
            ...
            @else
                Review and approve certificates assigned in the workflow.
            @endif
        </p>
    </div>
    @canMutate
            ...
            success: function (res) {
                ...
                $.each(res.data.data, function (i, d) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td>' + escapeHtml(d.location || 'N/A') + '</td>' +
                        '<td>' + escapeHtml(d.report_prepared_by) + '</td>' +
                        '<td>' + escapeHtml(d.report_approved_by) + '</td>' +
                        '<td>' + escapeHtml(d.review_by || 'N/A') + '</td>' +
                        '<td>' + escapeHtml(d.approval_by || 'N/A') + '</td>' +
                        '<td>' + formatDate(d.report_issue_date) + '</td>' +
                        '<td>' + formatDate(d.report_validity_date) + '</td>' +
