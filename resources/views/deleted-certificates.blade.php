...
<div class="page-heading">
    <div>
        ...
        <p>Soft-deleted certificates kept for audit and reference.</p>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-hover admin-table search-result">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="10" class="text-center text-muted py-4">No deleted certificates found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
            ...
            success: function (res) {
                ...
                $.each(res.data.data, function (index, data) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td>' + escapeHtml(data.report_prepared_by) + '</td>' +
                        '<td>' + formatDate(data.report_issue_date) + '</td>' +
                        '<td>' + formatDate(data.report_validity_date) + '</td>' +
